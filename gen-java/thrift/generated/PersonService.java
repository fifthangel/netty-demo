...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2019-06-20")
public class PersonService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void recv_savePerson() throws DataException, org.apache.thrift.TException
    {
      ...
      if (result.dataExption != null) {
        throw result.dataExption;
      }
      return;
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class savePerson<I extends Iface> extends org.apache.thrift.ProcessFunction<I, savePerson_args> {
      ...
      public savePerson_result getResult(I iface, savePerson_args args) throws org.apache.thrift.TException {
        ...
        } catch (DataException dataExption) {
          result.dataExption = dataExption;
        }
        return result;
      }
    }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Void> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Void>() { 
          ...
          public void onError(java.lang.Exception e) {
            ...
            savePerson_result result = new savePerson_result();
            if (e instanceof DataException) {
              result.dataExption = (DataException) e;
              result.setDataExptionIsSet(true);
              msg = result;
            } else if (e instanceof org.apache.thrift.transport.TTransportException) {
              _LOGGER.error("TTransportException inside handler", e);
              fb.close();
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_EXPTION_FIELD_DESC = new org.apache.thrift.protocol.TField("dataExption", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable DataException dataExption; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      DATA_EXPTION((short)1, "dataExption");
    ...
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.DATA_EXPTION, new org.apache.thrift.meta_data.FieldMetaData("dataExption", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DataException.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public savePerson_result(
      DataException dataExption)
    {
      this();
      this.dataExption = dataExption;
    }
    ...
    public savePerson_result(savePerson_result other) {
      if (other.isSetDataExption()) {
        this.dataExption = new DataException(other.dataExption);
      }
    }
    ...
    @Override
    public void clear() {
      this.dataExption = null;
    }

    @org.apache.thrift.annotation.Nullable
    public DataException getDataExption() {
      return this.dataExption;
    }

    public savePerson_result setDataExption(@org.apache.thrift.annotation.Nullable DataException dataExption) {
      this.dataExption = dataExption;
      return this;
    }

    public void unsetDataExption() {
      this.dataExption = null;
    }

    /** Returns true if field dataExption is set (has been assigned a value) and false otherwise */
    public boolean isSetDataExption() {
      return this.dataExption != null;
    }

    public void setDataExptionIsSet(boolean value) {
      if (!value) {
        this.dataExption = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case DATA_EXPTION:
        if (value == null) {
          ...
          setDataExption((DataException)value);
        }
        break;
    ...
    public boolean equals(savePerson_result that) {
      ...
      boolean this_present_dataExption = true && this.isSetDataExption();
      boolean that_present_dataExption = true && that.isSetDataExption();
      if (this_present_dataExption || that_present_dataExption) {
        if (!(this_present_dataExption && that_present_dataExption))
          return false;
        if (!this.dataExption.equals(that.dataExption))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDataExption()) ? 131071 : 524287);
      if (isSetDataExption())
        hashCode = hashCode * 8191 + dataExption.hashCode();
    ...
    public int compareTo(savePerson_result other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetDataExption()).compareTo(other.isSetDataExption());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataExption()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataExption, other.dataExption);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      sb.append("dataExption:");
      if (this.dataExption == null) {
        sb.append("null");
      } else {
        sb.append(this.dataExption);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class savePerson_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<savePerson_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, savePerson_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // DATA_EXPTION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExption = new DataException();
                struct.dataExption.read(iprot);
                struct.setDataExptionIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, savePerson_result struct) throws org.apache.thrift.TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.dataExption != null) {
          oprot.writeFieldBegin(DATA_EXPTION_FIELD_DESC);
          struct.dataExption.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
