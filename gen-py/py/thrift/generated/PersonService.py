...
class Client(Iface):
    ...
    def recv_savePerson(self):
        ...
        result.read(iprot)
        iprot.readMessageEnd()
        if result.dataExption is not None:
            raise result.dataExption
        return
...
class Processor(Iface, TProcessor):
    ...
    def process_savePerson(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except DataException as dataExption:
            msg_type = TMessageType.REPLY
...
class savePerson_result(object):
    ...
    def __init__(self, dataExption=None,):
        self.dataExption = dataExption
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.dataExption = DataException()
                    self.dataExption.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.dataExption is not None:
            oprot.writeFieldBegin('dataExption', TType.STRUCT, 1)
            self.dataExption.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
savePerson_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'dataExption', [DataException, None], None, ),  # 1
)
